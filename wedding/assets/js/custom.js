...
Project: faddiiiiiit - Responsive HTML Template
Version: 1.0.0
  ...
  var Wedding = {
    ...
    popupGallery: function () {
      jQuery(document).ready(function () {
        $(
          ".popup_gallery, .popup_gallery1, .popup_gallery2, .popup_gallery3"
        ).magnificPopup({
          delegate: "a",
          type: "image",
  ...
  if (check == 0) {
    ...
    $.ajax({
      ...
      if (resp == 1) {
        ...
        errroTarget.html('<p style="color:green;">Mail teb3th.</p>');
      } else {
        errroTarget.html('<p style="color:red;">baraa al3eb b3id.</p>');
      }
    });
  }
});
